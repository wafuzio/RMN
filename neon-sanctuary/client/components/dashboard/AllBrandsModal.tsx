    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="border-t pt-4 mt-4 space-y-3">
          ...
          {showFilters && (
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 pb-3 border-b">
          ...
          <div className="flex gap-2">
            <Button onClick={exportAsCSV} variant="outline" size="sm" className="flex-1 text-xs">
              CSV
            </Button>
            <Button onClick={exportAsJSON} variant="outline" size="sm" className="flex-1 text-xs">
              JSON
            </Button>
          </div>
        </div>
